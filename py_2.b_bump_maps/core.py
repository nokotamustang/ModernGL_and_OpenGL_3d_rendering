...
class Scene():
    ...
    def __init__(self, app):
        ...
        self.objects.append(Cube(app, position=(0, 0, 0), texture="wood", roughness=0.6, metallic=0.6))
        self.objects.append(Cube(app, position=(_g, 0, 0), texture="wood", roughness=0.6, metallic=0.6, bump="wood_bump_gl"))
