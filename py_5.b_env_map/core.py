...
class Prototype:
    ...
    def common_render_update(self):
        ...
        # Skybox reflection
        shader_program['u_cube_map'] = self.app.skybox_tex_id
        self.app.texture.textures[self.app.skybox_tex_id].use(location=self.app.skybox_tex_id)

        shader_program['skybox_material.a'].value = self.app.skybox.albedo
        shader_program['skybox_material.d'].value = self.app.skybox.roughness
        shader_program['skybox_material.s'].value = self.app.skybox.metallic
...
class Cube:
    def __init__(self, app, albedo=(1.0, 1.0, 1.0), roughness=0.75, metallic=0.25, reflectivity=0.0,
    ...
    def render(self):
        ...
        self.shader_program['material.r'].value = self.reflectivity
        # Render
        self.vao.render()
...
class Floor(Cube):
    def __init__(self, app, albedo=(1.0, 1.0, 1.0), roughness=0.9, metallic=0.2, reflectivity=0.0,
                 position=(0, 0, 0), scale=(1, 0.1, 1), texture: str = 'ground',
                 can_update=False):
        super().__init__(app, albedo, roughness, metallic, reflectivity, position,
...
class Scene():
    ...
    def __init__(self, app):
        ...
        # self.app.skybox = SkyBox(app, name="test")
        ...
        self.objects.append(Cube(app, position=(_g*4, 0, 0), texture="metal_1", roughness=0.0, metallic=0.0, reflectivity=1.0))
...
class SkyBox():
    def __init__(self, app, name='overcast_1k', albedo=(1.0, 1.0, 1.0), roughness=0.99, metallic=0.01,
    ...
    def render(self):
        ...
        self.shader_program['global_light.direction'].value = self.app.global_light.direction
